************************************************************
      StarIO for iOS Ver 3.14.1
         Readme_En.txt             Star Micronics Co., Ltd. 
************************************************************


 1. Overview
 2. Ver 3.14.1 Changes
 3. Contents
 4. Scope
 5. Remarks
 6. Copyright
...
=============
  ...
  StarIO_iOS_SDK_V3_14_1_20150717
  |
  ...
  |
  +- Documents
  |  +- README_StarIO_ESCPOS_PortablePrinter_iOS_SDK.pdf     // Master help file (English:  Portable Printer [ESC/POS Mode])
  |     README_StarIO_ESCPOS_PortablePrinter_iOS_SDK_Jp.pdf  // Master help file (Japanese: Portable Printer [ESC/POS Mode])
  ...
  |     README_StarIO_StarLinePortablePrinter_iOS_SDK.pdf    // Master help file (English:  Portable Printer [StarPRNT Mode])
  |     README_StarIO_StarLinePortablePrinter_iOS_SDK_Jp.pdf // Master help file (Japanese: Portable Printer [StarPRNT Mode])
  ...
  |
  +- Distributables
  |  +- StarIO.framework                // framework (v2.0.0)
  |
  +- Samples
    +- IOS_SDK.xcodeproj                // project file for sample program (v3.14.1)
       StarIO.framework                 // framework (v2.0.0)
...
=================
 ...
 =============
  ...
  1. Limitation of SAC10 F/W Ver 1.0
     ...
     You can confirm the F/W version by gStar Setting Utilityh.
     ...
     gMain F/Wh box will show the F/W version. 

     If you use Telnet for this procedure, please refer to the 
     gProduct Specifications Manual SAC10 Series".
